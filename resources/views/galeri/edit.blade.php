...
@section('content')
    ...
    [&>div>textarea]:text-secondary [&>div>textarea]:rounded-lg [&>div>textarea]:text-sm [&>div>textarea]:block [&>div>textarea]:w-full [&>div>textarea]:border [&>div>textarea]:shadow-sm [&>div>input]:text-secondary [&>div>input]:rounded-lg [&>div>input]:text-sm [&>div>input]:block [&>div>input]:w-full [&>div>input]:border [&>div>input]:shadow-sm">
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar1)
                    <img src="{{ asset('storage/' . $galeri->gambar1) }}" class="w-[200px] mb-2 block previewImage">
                @else
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar2)
                    <img src="{{ asset('storage/' . $galeri->gambar2) }}" class="w-[200px] mb-2 block previewImage">
                @else
                    <img src="" class="previewImage">
                @endif
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar3)
                    <img src="{{ asset('storage/' . $galeri->gambar3) }}" class="w-[200px] mb-2 block previewImage">
                @else
                    <img src="" class="previewImage">
                @endif
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar4)
                    <img src="{{ asset('storage/' . $galeri->gambar4) }}" class="w-[200px] mb-2 block previewImage">
                @else
                    <img src="" class="previewImage">
                @endif
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar5)
                    <img src="{{ asset('storage/' . $galeri->gambar5) }}" class="w-[200px] mb-2 block previewImage">
                @else
                    <img src="" class="previewImage">
                @endif
            ...
            <div class="mb-6">
                ...
                @if ($galeri->gambar6)
                    <img src="{{ asset('storage/' . $galeri->gambar6) }}" class="w-[200px] mb-2 block previewImage">
                @else
                    <img src="" class="previewImage">
                @endif
