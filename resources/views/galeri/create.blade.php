    ...
    [&>div>textarea]:text-secondary [&>div>textarea]:rounded-lg [&>div>textarea]:text-sm [&>div>textarea]:block [&>div>textarea]:w-full [&>div>textarea]:border [&>div>textarea]:shadow-sm [&>div>input]:text-secondary [&>div>input]:rounded-lg [&>div>input]:text-sm [&>div>input]:block [&>div>input]:w-full [&>div>input]:border [&>div>input]:shadow-sm">
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar1" type="file" name="gambar1" onchange="previewImage()"></input>
                @error('gambar1')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar2" type="file" name="gambar2" onchange="previewImage()"></input>
                @error('gambar2')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar3" type="file" name="gambar3" onchange="previewImage()"></input>
                @error('gambar3')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar4" type="file" name="gambar4" onchange="previewImage()"></input>
                @error('gambar4')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar5" type="file" name="gambar5" onchange="previewImage()"></input>
                @error('gambar5')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="gambar6" type="file" name="gambar6" onchange="previewImage()"></input>
                @error('gambar6')
                    <p class="mt-1 text-xs text-danger">{{ $message }}</p>
                @enderror
            </div>
